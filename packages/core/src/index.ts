...
import { DagreLayoutEngine, resolveLayout, type LayoutEngine, type LayoutOptions } from '@sculpt/layout';
...
export interface RenderResult { svg: string; ast: DiagramAst; width: number; height: number }
